...
<body>
    <div class="sidebar">
        ...
        <a href="profiles.php" style="background:lightgray; color:#464646;">
        ...
        <a href="reports.php">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-activity"
                viewBox="0 0 16 16">
                <path fill-rule="evenodd"
        ...
        <a href="seasonal_diseases.php">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bullseye"
                viewBox="0 0 16 16">
    ...
    <div class="main">
        <div class="one">
            <p class="welcome" style="width:100%; position:left;">Welcome <strong>
                    <?php echo $_SESSION['username']; ?>
                </strong>!</p>
            <p class="logout" style="width:70px; position:right;"><a class="logout" href="logout.php"
