    ...
    <body>
        <?php
            ...
            if (isset($_REQUEST['username'])) {
                ...
                $query    = "INSERT into `patient_account` (first_name, last_name, middle_initial, username, password, email, create_datetime)
                            VALUES ('$first_name','$last_name','$middle_initial','$username', '" . md5($password) . "', '$email', '$create_datetime')";
